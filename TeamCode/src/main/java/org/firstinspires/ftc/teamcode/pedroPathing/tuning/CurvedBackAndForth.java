...
public class CurvedBackAndForth extends OpMode {
    ...
    public void init() {
        ...
        follower.setPose(new Pose(1.367, 119.597, Math.toRadians(90)));
        ...
        builder
            .addPath(
                // Line 1
                new BezierCurve(
                    new Point(1.367, 119.597, Point.CARTESIAN),
                    new Point(17.375, 120.377, Point.CARTESIAN),
                    new Point(12.690, 130.920, Point.CARTESIAN)
                )
            )
