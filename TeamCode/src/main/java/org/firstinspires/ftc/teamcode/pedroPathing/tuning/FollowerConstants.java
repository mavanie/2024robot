...
public class FollowerConstants {
    ...
    private static double xMovement = 56.93817623341731;
    private static double yMovement = 43.36480736352571;
    ...
    public static double forwardZeroPowerAcceleration = -46.409504425703936;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -77.14384697775778;
